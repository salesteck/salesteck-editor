 ...
 * used by {@link @ckEditor5/table/tablecellproperties/ui/tablecellpropertiesview~TableCellPropertiesView}.
 *
 * **Note**: For now this class is private-attribute. When more use cases arrive (beyond ckeditor5-table),
...
export default class FormRowView extends View {
     ...
     * @param {Array.<@ckEditor5/ui/_view~View>} options.children
     * @param {String} [options.class]
     * @param {@ckEditor5/ui/_view~View} [options.labelView] When passed, the row gets the `group` and `aria-labelledby`
