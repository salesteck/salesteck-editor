...
import {ITEM_CLASS, PARENT_CLASS} from "./listediting";
 ...
 *
 * @see @ckEditor5/engine/conversion/downcastdispatcher~DowncastDispatcher#event:remove
 * @param {@ckEditor5/engine/model/model~Model} model Model instance.
 * @returns {Function} Returns a conversion callback.
 */
 ...
 * Check {@link @ckEditor5/list/todolistconverters~modelViewChangeType} to see an example of it.
 *
 * @see @ckEditor5/engine/conversion/downcastdispatcher~DowncastDispatcher#event:attribute
 * @param {@ckEditor5/utils/eventinfo~EventInfo} evt An object containing information about the fired event.
 * @param {Object} data Additional information about the change.
 * @param {@ckEditor5/engine/conversion/downcastdispatcher~DowncastConversionApi} conversionApi Conversion interface.
 */
...
export function viewModelConverter( evt, data, conversionApi ) {
	if ( conversionApi.consumable.consume( data.viewItem, { name: true } ) ) {
		...
		writer.setAttribute( ITEM_CLASS, itemCLass, listItem );
		//TODO added for class
		if(data.viewItem.parent){
			const parentClass = data.viewItem.parent.getAttribute('class') || '';
			writer.setAttribute( PARENT_CLASS, parentClass, listItem );
		}
...
/**
 * Returns a callback for model position to view position mapping for {@link @ckEditor5/engine/conversion/mapper~Mapper}. The callback fixes
 * positions between the `listItem` elements that would be incorrectly mapped because of how list items are represented in the model
 * and in the view.
 *
 * @see @ckEditor5/engine/conversion/mapper~Mapper#event:modelToViewPosition
 * @param {@ckEditor5/engine/view/view~View} view A view instance.
 * @returns {Function}
 */
...
/**
 * The callback for view position to model position mapping for {@link @ckEditor5/engine/conversion/mapper~Mapper}. The callback fixes
 * positions between the `<li>` elements that would be incorrectly mapped because of how list items are represented in the model
 * and in the view.
 *
 * @see @ckEditor5/engine/conversion/mapper~Mapper#event:viewToModelPosition
 * @param {@ckEditor5/engine/model/model~Model} model Model instance.
 * @returns {Function} Returns a conversion callback.
 */
 ...
 *
 * @param {@ckEditor5/engine/model/model~Model} model The data model.
 * @param {@ckEditor5/engine/model/writer~Writer} writer The writer to do changes with.
 ...
 *
 * @param {@ckEditor5/utils/eventinfo~EventInfo} evt An object containing information about the fired event.
 * @param {Array} args Arguments of {@link @ckEditor5/engine/model/model~Model#insertContent}.
 */
...
//
// @param {@ckEditor5/engine/model/element~Element} listItemModel List item model element to which converted children will be inserted.
// @param {Iterable.<@ckEditor5/engine/view/node~Node>} viewChildren View elements which will be converted.
// @param {@ckEditor5/engine/conversion/upcastdispatcher~UpcastConversionApi} conversionApi Conversion interface to be used by the callback.
// @returns {@ckEditor5/engine/model/position~Position} Position on which next elements should be inserted after children conversion.
...
//
// @param {@ckEditor5/engine/view/element~Element} viewElement
// @returns {Boolean}
...
//
// @param {@ckEditor5/engine/view/element~Element} listItem
