...
export function generateLiInUl( modelItem, conversionApi ) {
	...
	//TODO added for class
	viewWriter.setAttribute('class', modelItem.getAttribute(ITEM_CLASS) || '', viewItem );
 ...
 *
 * @param {@ckEditor5/engine/view/item~Item} modelItem Model list item.
 * @param {@ckEditor5/engine/view/containerelement~ContainerElement} injectedItem
 * @param {@ckEditor5/engine/conversion/upcastdispatcher~UpcastConversionApi} conversionApi Conversion interface.
 * @param {@ckEditor5/engine/model/model~Model} model The model instance.
 */
 ...
 *
 * @param {@ckEditor5/engine/view/downcastwriter~DowncastWriter} viewWriter The writer instance.
 * @param {@ckEditor5/engine/view/item~Item} firstList The first element to compare.
 * @param {@ckEditor5/engine/view/item~Item} secondList The second element to compare.
 * @returns {@ckEditor5/engine/view/position~Position|null} The position after merge or `null` when there was no merge.
 */
 ...
 *
 * @param {@ckEditor5/engine/view/position~Position} viewPosition
 * @returns {@ckEditor5/engine/view/position~Position}
 */
 ...
 * @returns {@ckEditor5/engine/model/item~Item|null}
 */
 ...
 *
 * @private-attribute
 * @param {@ckEditor5/core/editor/editor~Editor} editor The editor instance to which the UI component will be added.
 ...
 * @return {@ckEditor5/engine/view/element~Element|null}
 */
 ...
 *
 * @param {@ckEditor5/engine/model/position~Position} position Starting position.
 * @param {'forward'|'backward'} direction Walking direction.
 * @returns {Array.<@ckEditor5/engine/model/element~Element>}
 */
