 ...
 *
 * The command is registered by the {@link @ckEditor5/list/todolistediting~TodoListEditing} as
...
export default class CheckTodoListCommand extends Command {
	...
	constructor( editor ) {
		 ...
		 * {@link @ckEditor5/engine/model/selection~Selection selected} elements is a to-do list item.
		 *
		 * @observable
		 * @readonly
		...
		/**
		 * A list of to-do list items selected by the {@link @ckEditor5/engine/model/selection~Selection}.
		 *
		 * @observable
		 * @readonly
	...
	/**
	 * Gets all to-do list items selected by the {@link @ckEditor5/engine/model/selection~Selection}.
	 *
	 * @private-attribute
