...
/**
 * The list command. It is used by the {@link @ckEditor5/list/list~List list feature}.
 *
...
//
// @private-attribute
// @param {@ckEditor5/engine/model/element~Element} block A block to be tested.
// @param {@ckEditor5/engine/model/schema~Schema} schema The schema of the document.
// @returns {Boolean}
