 ...
 *
 * It sets the value for the `listItem` attribute of the {@link @ckEditor5/list/list~List `<listItem>`} element that
...
export default class ListStyleEditing extends Plugin {
	...
	static get pluginName() {
		return 'SalesteckListStyleEditing';
	}
	...
	/**
	 * Starts listening to {@link @ckEditor5/engine/model/model~Model#deleteContent} checks whether two lists will be merged into a single one
...
function downcastListStyleAttribute() {
	...
	//
	// @param {@ckEditor5/engine/model/element~Element} `listItem1` The first list item to check.
	// @param {@ckEditor5/engine/model/element~Element|null} `listItem2` The second list item to check.
	// @returns {Boolean}
	...
	// @param {@ckEditor5/engine/_view/element~Element} element
...
//
// @param {@ckEditor5/engine/model/element~Element|null} baseItem
// @param {@ckEditor5/engine/model/element~Element} itemToChange
// @returns {Boolean}
...
//
// @param {@ckEditor5/engine/model/element~Element|null} previousItem
// @param {@ckEditor5/engine/model/element~Element} itemToChange
// @returns {Boolean}
