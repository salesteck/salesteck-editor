 ...
 *
 * It registers the entire functionality of the {@link @ckEditor5/list/listediting~ListEditing list editing plugin} and extends
...
export default class TodoListEditing extends Plugin {
	...
	static get pluginName() {
		return 'SalesteckTodoListEditing';
	}
	 ...
	 *
	 * @private-attribute
	 * @param {@ckEditor5/engine/model/element~Element} listItem
	 */
