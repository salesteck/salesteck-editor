 ...
 *
 * **Note**: Buttons introduced by this plugin override implementations from the {@link @ckEditor5/list/listui~ListUI}
...
// @param {@ckEditor5/core/editor/editor~Editor} options.editor
...
// @returns {Function} A function that can be passed straight into {@link @ckEditor5/ui/componentfactory~ComponentFactory#add}.
...
// @param {Object} options
// @param {@ckEditor5/core/editor/editor~Editor} options.editor
// @param {@ckEditor5/list/liststylecommand~ListStylesCommand} options.listStyleCommand The instance of the `ListStylesCommand` class.
...
function getStyleButtonCreator( { editor, listStyleCommand, parentCommandName } ) {
	...
	// @returns {@ckEditor5/ui/button/buttonview~BsButtonView}
