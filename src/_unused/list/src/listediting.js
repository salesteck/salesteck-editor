...
export const ITEM_CLASS = 'itemClass';
...
export default class ListEditing extends Plugin {
	...
	init() {
		...
		editor.model.schema.register( 'listItem', {
			...
			allowAttributes: [ 'listType', 'listIndent', PARENT_CLASS, ITEM_CLASS ]
		} );
	...
	afterInit() {
		...
		// console.log(this.editor.plugins.get('ListEditing'))
	}
}
