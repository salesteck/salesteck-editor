 ...
 * The link plugin.
 *
 * This is a "glue" plugin that loads the {@link @ckeditor5/link/linkediting~LinkEditing link editing feature}
 * and {@link @ckeditor5/link/linkui~LinkUI link UI feature}.
 *
 * @extends @ckeditor5/core/plugin~Plugin
 */
export default class SalesteckLink extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
		return [ SalesteckLinkEditing, 'LinkEditing'/*, LinkUI, AutoLink*/ ];
	}
	...
	static get pluginName() {
		return 'SalesteckLink';
	}
}

/**
 * The configuration of the {@link @ckeditor5/link/link~Link} feature.
 *
 * Read more in {@link @ckeditor5/link/link~LinkConfig}.
 *
 * @member {@ckeditor5/link/link~LinkConfig} @ckeditor5/core/editor/editorconfig~EditorConfig#link
 */

/**
 * The configuration of the {@link @ckeditor5/link/link~Link link feature}.
 *
 *		ClassicEditor
 ...
 *			.catch( ... );
 *
 * See {@link @ckeditor5/core/editor/editorconfig~EditorConfig all editor options}.
 ...
 *
 * @member {String} @ckeditor5/link/link~LinkConfig#defaultProtocol
 */
 ...
 *			.catch( ... );
 *
 * Internally, this option activates a predefined {@link @ckeditor5/link/link~LinkConfig#decorators automatic link decorator}
 ...
 * {@link @ckeditor5/link/link~LinkDecoratorManualDefinition manual} decorator must be defined in the
 * {@link @ckeditor5/link/link~LinkConfig#decorators `config.link.decorators`} array. In such scenario,
 ...
 *
 * It is possible to add other {@link @ckeditor5/link/link~LinkDecoratorAutomaticDefinition automatic}
 * or {@link @ckeditor5/link/link~LinkDecoratorManualDefinition manual} link decorators when this option is active.
 *
 * More information about decorators can be found in the {@link @ckeditor5/link/link~LinkConfig#decorators decorators configuration}
 * reference.
 *
 * @default false
 * @member {Boolean} @ckeditor5/link/link~LinkConfig#addTargetToExternalLinks
 */
 ...
 *
 * * {@link @ckeditor5/link/link~LinkDecoratorAutomaticDefinition Automatic} &ndash; They match links against pre–defined rules and
 * manage their attributes based on the results.
 * * {@link @ckeditor5/link/link~LinkDecoratorManualDefinition Manual} &ndash; They allow users to control link attributes individually,
 *  using the editor UI.
 *
 ...
 *			.catch( ... );
 *
 * To learn more about the configuration syntax, check out the {@link @ckeditor5/link/link~LinkDecoratorAutomaticDefinition automatic}
 * and {@link @ckeditor5/link/link~LinkDecoratorManualDefinition manual} decorator option reference.
 *
 ...
 * {@link @ckeditor5/link/link~LinkConfig#addTargetToExternalLinks `config.link.addTargetToExternalLinks`}
 * configuration description to learn more.
 *
 * See also the {@glink features/link#custom-link-attributes-decorators link feature guide} for more information.
 *
 * @member {Object.<String, @ckeditor5/link/link~LinkDecoratorDefinition>} @ckeditor5/link/link~LinkConfig#decorators
 */

/**
 * A link decorator definition. Two types implement this defition:
 *
 * * {@link @ckeditor5/link/link~LinkDecoratorManualDefinition}
 * * {@link @ckeditor5/link/link~LinkDecoratorAutomaticDefinition}
 *
 ...
 *
 * @member {'manual'|'automatic'} @ckeditor5/link/link~LinkDecoratorDefinition#mode
 */

/**
 * Describes an automatic {@link @ckeditor5/link/link~LinkConfig#decorators link decorator}. This decorator type matches
 ...
 * configuration description to learn more.
 *
 * @typedef {Object} @ckeditor5/link/link~LinkDecoratorAutomaticDefinition
 ...
 * Attributes should follow the {@link @ckeditor5/engine/view/elementdefinition~ElementDefinition} syntax.
 */

/**
 * Describes a manual {@link @ckeditor5/link/link~LinkConfig#decorators link decorator}. This decorator type is represented in
 * the link feature's {@link @ckeditor5/link/linkui user interface} as a switch that the user can use to control the presence
 ...
 *		}
 *
 * @typedef {Object} @ckeditor5/link/link~LinkDecoratorManualDefinition
