...
import MediaResizeButtons from './mediaresize/mediaresizebuttons';
import MediaResizeEditing from './mediaresize/mediaresizeediting';
import MediaResizeHandles from './mediaresize/mediaresizehandles';

// import './resize/mediaresize.css';
 ...
 */
export default class MediaResize extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
