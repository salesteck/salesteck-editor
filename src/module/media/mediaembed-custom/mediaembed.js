 ...
 *
 * * The {@link @ckEditor5/media-embed/mediaembedediting~MediaEmbedEditing media embed editing feature},
 * * The {@link @ckEditor5/media-embed/mediaembedui~MediaEmbedUI media embed UI feature} and
 * * The {@link @ckEditor5/media-embed/automediaembed~AutoMediaEmbed auto-media embed feature}.
 *
...
export default class MediaEmbed extends Plugin {
	...
	static get pluginName() {
		return 'SalesteckMediaEmbed';
	}
}

/**
 * The media embed provider descriptor. Used in
 * {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig#providers `config.mediaEmbed.providers`} and
 * {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig#extraProviders `config.mediaEmbed.extraProviders`}.
 *
 * See {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig} to learn more.
 *
 *		{
 *			name: 'example',
 *
 ...
 *			// Used to represent the media when editing the content (i.e. in the _view)
 ...
 *		}
 *
 * @typedef {Object} @ckEditor5/media-embed/mediaembed~MediaEmbedProvider
 * @property {String} name The name of the provider. Used e.g. when
 * {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig#removeProviders removing providers}.
 ...
 * will use a generic media representation in the _view and output data.
 * Note that when
 * {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig#previewsInData `config.mediaEmbed.previewsInData`}
 * is `true`, the rendering function **will always** be used for the media in the editor data output.
 */

/**
 * The configuration of the {@link @ckEditor5/media-embed/mediaembed~MediaEmbed} feature.
 *
 * Read more in {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig}.
 *
 * @member {@ckEditor5/media-embed/mediaembed~MediaEmbedConfig} @ckEditor5/core/editor/editorconfig~EditorConfig#mediaEmbed
 */
 ...
 * * "facebook"
 *
 * See the {@link @ckEditor5/media-embed/mediaembed~MediaEmbedProvider provider syntax} to learn more about
 ...
 * {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig#previewsInData `config.mediaEmbed.previewsInData`} to
 ...
 * {@link @ckEditor5/media-embed/mediaembed~MediaEmbedProvider definitions}:
 *
 *		ClassicEditor
 *			.create( editorElement, {
 *				plugins: [ MediaEmbed, ... ],
 ...
 * {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig#removeProviders `config.mediaEmbed.removeProviders`}.
 *
 * @member {Array.<@ckEditor5/media-embed/mediaembed~MediaEmbedProvider>} module:media-embed/mediaembed~MediaEmbedConfig#providers
 */

/**
 * The additional media providers supported by the editor. This configuration helps extend the default
 * {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig#providers}.
 *
 *		ClassicEditor
 *			.create( editorElement, {
 *				plugins: [ MediaEmbed, ... ],
 ...
 *			.catch( ... );
 *
 * See the {@link @ckEditor5/media-embed/mediaembed~MediaEmbedProvider provider syntax} to learn more.
 *
 ...
 * in the {@link @ckEditor5/media-embed/mediaembed~MediaEmbedConfig#providers `config.mediaEmbed.providers`}
