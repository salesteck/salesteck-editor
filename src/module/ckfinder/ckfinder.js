...
import CKFinderEditing from "./ckfinder-editing";
 ...
 *
 * * {@link @ckEditor5/ckfinder/ckfinderediting~CKFinderEditing},
 * * {@link @ckEditor5/ckfinder/ckfinderui~CKFinderUI},
 * * {@link @ckEditor5/adapter-ckfinder/uploadadapter~CKFinderUploadAdapter}.
 *
...
export default class CKFinder extends Plugin {
     ...
     */
    static get requires() {
        return [ 'Image', 'CKFinderUploadAdapter', CKFinderEditing ];
    }
}

/**
 * The configuration of the {@link @ckEditor5/ckfinder/ckfinder~CKFinder CKFinder feature}.
 *
 * Read more in {@link @ckEditor5/ckfinder/ckfinder~CKFinderConfig}.
 *
 * @member {@ckEditor5/ckfinder/ckfinder~CKFinderConfig} module:core/editor/editorconfig~EditorConfig#ckfinder
 */

/**
 * The configuration of the {@link @ckEditor5/ckfinder/ckfinder~CKFinder CKFinder feature}
 * and its {@link @ckEditor5/adapter-ckfinder/uploadadapter~CKFinderUploadAdapter upload adapter}.
 *
 *		ClassicEditor
 ...
 *			.catch( ... );
 *
 * Used by the {@link @ckEditor5/adapter-ckfinder/uploadadapter~CKFinderUploadAdapter upload adapter}.
 *
