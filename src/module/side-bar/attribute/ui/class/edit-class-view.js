...
export default class EditClassView extends AccordionItemView{
    ...
    constructor(local, editor,  options = {}) {
        ...
        // console.log("EditIdView.constructor", {arguments});
    ...
    render() {
        ...
        this.on('hidden', (evt) =>{
            // console.log( `EditClassView:'hidden'`/*, {collapse: collapse}*/ );
